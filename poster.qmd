...
![Slumping of a suspension of silica sand ($d\sim180~\mu$m).](src/images.png){fig-align="center"}

![](src/QRcodes/video_lock_release.svg){.absolute top=20 left=1430 width=50 height=50 #QRcodemain}

::: {#mainMessage}
**Bottom slope** and **particle settling** matters for **turbidity current** slumping dynamics !
:::
...
::: {#posterfooter}
C. Gadal, M. Mercier and L. Lacaze. Insitut de Mécanique des Fluides de Toulouse (IMFT), France
:::
...
- slumping regime: first, constant-velocity, phase of current propagation (see intro)
